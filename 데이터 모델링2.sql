use `hospital`;
# 진료과 insert
alter table `doctors` modify column `doc_gen` varchar(1);
...
# 의사 insert
insert into `doctors`(`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`)
values('D101101','김유신','1976-01-21','M','101','과장','010-1101-1976','kimys@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D101102','계백','1975-06-11','M','101','전문의','010-1102-1975','gaeback@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D101103','김관창','1989-05-30','M','101','전문의','010-1103-1989','kwanch@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D102101','김춘추','1979-04-13','M','102','과장','010-2101-1979','kimcc@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D102104','이사부','1966-09-12','M','102','전문의','010-2104-1966','leesabu@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D103101','장보고','1979-07-28','M','103','과장','010-3101-1979','jangbg@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D104101','선덕여왕','1984-06-15','F','104','과장','010-4101-1984','gueen@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D105101','강감찬','1965-10-21','M','105','과장','010-5101-1965','kang@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D106101','심사임당','1972-11-28','F','106','과장','010-6101-1972','sinsa@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D107103','이이','1992-09-07','M','107','전문의','010-7103-1992','leelee@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D107104','이황','1989-12-09','M','107','전문의','010-7104-1989','hwang@bw.com');
insert into `doctors` (`doc_id`,`doc_name`,`doc_birth`,`doc_gen`,`dep_no`,`doc_pos`,`doc_phone`,`doc_email`) 
values('D108101','송상현','1977-03-14','M','108','과장','010-8101-1977','ssh@bw.com');
# 간호사 insert
insert into `nurses` (`nur_id`,`nur_name`,`nur_birth`,`nur_gender`,`dep_no`,`nur_pos`,`nur_phone`,`nur_email`) 
values('N101101','송승헌','1976-02-21','M','101','수간호사','010-1101-7602','ssh@bw.com');
insert into `nurses` (`nur_id`,`nur_name`,`nur_birth`,`nur_gender`,`dep_no`,`nur_pos`,`nur_phone`,`nur_email`) 
values('N102101','이영애','1975-07-11','F','102','수간호사','010-1102-7507','yung@bw.com');
insert into `nurses` (`nur_id`,`nur_name`,`nur_birth`,`nur_gender`,`dep_no`,`nur_pos`,`nur_phone`,`nur_email`) 
values('N102102','엄정화','1989-06-30','F','102','주임','010-1103-8906','um@bw.com');
insert into `nurses` (`nur_id`,`nur_name`,`nur_birth`,`nur_gender`,`dep_no`,`nur_pos`,`nur_phone`,`nur_email`) 
values('N102103','박명수','1979-05-13','M','102','주임','010-2101-7905','park@bw.com');
insert into `nurses` (`nur_id`,`nur_name`,`nur_birth`,`nur_gender`,`dep_no`,`nur_pos`,`nur_phone`,`nur_email`) 
values('N103101','정준하','1966-10-12','M','103','주임','010-2104-6610','jung@bw.com');
insert into `nurses` (`nur_id`,`nur_name`,`nur_birth`,`nur_gender`,`dep_no`,`nur_pos`,`nur_phone`,`nur_email`) 
values('N104101','김태희','1979-08-28','F','104','주임','010-3101-7908','taeh@bw.com');
insert into `nurses` (`nur_id`,`nur_name`,`nur_birth`,`nur_gender`,`dep_no`,`nur_pos`,`nur_phone`,`nur_email`) 
values('N105101','송혜교','1984-07-15','F','105','주임','010-4101-8407','song@bw.com');
insert into `nurses` (`nur_id`,`nur_name`,`nur_birth`,`nur_gender`,`dep_no`,`nur_pos`,`nur_phone`,`nur_email`) 
values('N106101','공유','1965-11-21','M','106','간호사','010-5101-6511','gong@bw.com');
insert into `nurses` (`nur_id`,`nur_name`,`nur_birth`,`nur_gender`,`dep_no`,`nur_pos`,`nur_phone`,`nur_email`) 
values('N107101','이병헌','1972-12-28','M','107','간호사','010-6101-7212','byung@bw.com');
insert into `nurses` (`nur_id`,`nur_name`,`nur_birth`,`nur_gender`,`dep_no`,`nur_pos`,`nur_phone`,`nur_email`) 
values('N108101','송중기','1992-10-07','M','108','간호사','010-7103-9210','jungi@bw.com');
# 환자 insert
delete from `patients` where `pat_name` = '정우성';
...
insert into `patients` values('P105101','D105101','N105101','원빈','660912-1234567','M','대전','010-2014-6609','one@daum.net','배우');
...
# 문제1
select `doc_id`,`doc_name`,`doc_birth`,doc.`dep_no`,`dep_name`
from `doctors` as doc
join `departments` as dep
on dep.`dep_no` = doc.`dep_no`;
# 문제2
select `nur_id`,`nur_name`,`nur_birth`,nur.`dep_no`,`dep_name`
from `nurses` as nur
join `departments` as dep
on dep.`dep_no` = nur.`dep_no`;
# 문제3
select `pat_id`,`pat_name`,`pat_jumin`,`pat_phone`,`doc_name`,`nur_name`
from `patients` as pat
join `doctors` as doc on pat.`doc_id` = doc.`doc_id`
join `nurses` as nur on pat.`nur_id` = nur.`nur_id`;
# 문제4
select `pat_name`,`doc_name`,`treat_contents`,`chart_contents`,`treat_datetime`
from `treatments`as t
join `patients` as pat on t.`pat_id` = pat.`pat_id`
join `doctors` as doc on t.`doc_id` = doc.`doc_id`
join `charts` as ch on t.`treat_no` = ch.`treat_no`;
# 문제5
select t.`treat_no` `pat_name`,`doc_name`,`treat_contents`,`chart_contents`,`treat_datetime`
from `treatments`as t
join `patients` as pat on t.`pat_id` = pat.`pat_id`
join `doctors` as doc on t.`doc_id` = doc.`doc_id`
join `charts` as ch on t.`treat_no` = ch.`treat_no`
where doc.`dep_no` = (select `dep_no` from `departments` where `dep_name` = '외과');
...
join `doctors` as doc on t.`doc_id` = doc.`doc_id`
join `charts` as ch on t.`treat_no` = ch.`treat_no`
where t.`treat_contents` like '%화상%';
# 문제7
select * 
, year(now()) - concat('19',substring(`pat_jumin`,1,2)) as `age`
from `patients`
where year(now()) - concat('19',substring(`pat_jumin`,1,2))>= 30 and year(now()) - concat('19',substring(`pat_jumin`,1,2)) < 40;
...
where `nur_name` = '김태희';
# 문제10
select a.nur_id, a.nur_name, count(*) from `nurses` as a
join `patients` as b on a.nur_id = b.nur_id
group by a.`nur_id`
